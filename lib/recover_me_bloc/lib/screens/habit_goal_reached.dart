...
class HabitGoalReachedPage extends StatefulWidget {
  ...
  @override
  State<HabitGoalReachedPage> createState() => _HabitGoalReachedPageState();
}

class _HabitGoalReachedPageState extends State<HabitGoalReachedPage>
          ...
          Center(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'You just reached your habit goal of ${widget.goal}!',
...
class GlitterPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < sparkleCount; i++) {
      ...
      final opacity = (1.0 - pulsingEffect).clamp(0.2, 1.0);  
